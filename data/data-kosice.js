...
window.VAA_DATA.questions.kosice_primator = [
  ...
  {t:'Bývanie',q:'Má magistrát Košíc stavať nájomné byty na vlastných pozemkoch aj vtedy, ak by ich predaj súkromným developerom priniesol mestu viac peňazí na iné investície?',info:'Mesto Košice vlastní desiatky nevyužívaných alebo čiastočne využívaných budov, napríklad bývalé školy, administratívne objekty a správcovské domy. Magistrát v roku 2024 zrekonštruoval šesť mestských bytov pre rodiny v núdzi v spolupráci s organizáciou Úsmev ako dar. Každá takáto rekonštrukcia stojí desiatky tisíc eur, no mestu zostáva majetok a kontrola nad nájmom. Predaj tých istých budov prinesie jednorazový príjem, no mestu zmizne možnosť ovplyvňovať dostupnosť bývania.',a:{polac:'neutral',mudrak:'agree',lorinc:'neutral'}},
  {t:'Bývanie',q:'Má primátor urýchliť vydávanie stavebných povolení pre väčšie projekty, aj keby to znamenalo menej priestoru pre námietky obyvateľov dotknutých štvrte?',info:'Priemerná doba vybavenia stavebného povolenia v Košiciach trvá 12 až 18 mesiacov, čo je dvojnásobok európskeho priemeru. Zdĺhavý proces predražuje projekty a odrádzal investorov. Na druhej strane, zníženie kontroly môže umožniť výstavbu, ktorá ignoruje záujmy existujúcich obyvateľov a zaťažuje infraštruktúru.',a:{polac:'agree',mudrak:'neutral',lorinc:'agree'}},
  ...
  {t:'Samospráva',q:'Má primátor Košíc presadiť zlúčenie mestských častí aj napriek odporu ich starostov, ak je za to väčšina v mestskom zastupiteľstve?',info:'Košice sú rozdelené na 22 mestských častí, čo je viac ako Paríž, Barcelona či New York. Samotná prevádzka 22 miestnych úradov, platov starostov a odmien viac ako 300 poslancov stojí mesto 8,7 milióna eur ročne, teda takmer 35 miliónov za volebné obdobie. Starostovia mestských častí sa zlúčeniu dlhodobo bránia, hoci mestské zastupiteľstvo má kompetenciu o tom rozhodnúť. Otázka je, či má primátor použiť politický kapitál na presadenie reformy, alebo hľadať konsenzus, ktorý sa za 30 rokov nenašiel.',a:{polac:'neutral',mudrak:'neutral',lorinc:'agree'}},
  ...
  {t:'Doprava',q:'Má DPMK fungovať ako nezávislá profesionálna firma s jasnými výkonnostnými zmluvami, bez priamych zásahov primátora do jej riadenia?',info:'DPMK skončil v roku 2024 so stratou takmer 830 000 eur. Dotácia mesta vzrástla za šesť rokov z 19 miliónov na rekordných 37 miliónov eur ročne, pričom kvalita dopravy neklesla, ale ani nerástla. V roku 2023 prepukol ostrý štrajk vodičov, MHD sa takmer zastavila. DPMK zmeškal eurofondový tender na 20 miliónov eur na nové električky. Celá táto kríza sa odohrávala na pozadí rokov trvajúceho verejného konfliktu medzi primátorom a riaditeľom podniku, pričom obaja si navzájom hadzali vinu za zlý stav. Nový primátor zdedí podnik s rastúcimi nákladmi, zastaraným vozovým parkom a bez jasných pravidiel zodpovednosti.',a:{polac:'disagree',mudrak:'agree',lorinc:'neutral'}},
  ...
  {t:'Bezpečnosť',q:'Chceš, aby mestskí policajti v Košiciach pravidelne pešo hliadkovali v konkrétnych štvrtiach, poznali miestnych obyvateľov a zúčastňovali sa komunitných stretnutí, namiesto toho aby len reagovali na tiesňové volania z áut?',info:'Mestská polícia Košíc funguje prevažne reakčne a hliadkuje prevažne v autách. Komunitný model polície znamená, že každý policajt má pridelenú konkrétnu štvrť, v ktorej dlhodobo pôsobí, pozná ľudí a problémy priamo v teréne. V Manchestri sa vďaka tomuto modelu kriminalita znížila o 20 % za päť rokov. V Amsterdame má každá štvrť dedikovaného komunitného policajta. V Košiciach takýto systém neexistuje.',a:{polac:'agree',mudrak:'agree',lorinc:'agree'}},
  ...
  {t:'Sovietský pamätník',q:'Má primátor Košíc aktívne presadzovať odstránenie komunistických symbolov z vojenského pamätníka Červenej armády a premenovanie Námestia osloboditeľov?',info:'V centre Košíc stojí pamätník sovietskeho vojaka s kosákmi a kladivami, symbolmi komunistickej strany, ktorej systém zákon č. 125/1996 Z.z. označuje za zločinecký, nemorálny a protiprávny. Tá istá armáda, ktorá v januári 1945 vyhnala fašistov, obsadila Československo a uvrhla ho do 40 rokov totality. Na tomto námestí v auguste 1968 sovietske tanky zabíjali ľudí, ktorí sa bránili vojenskej invázii. Pritom Košice boli v roku 1919 oslobodené legionármi od boľševickej maďarskej armády a námestie sa vtedy premenovalo na Legionárske. V roku 1949 komunisti toto meno vymazali. Pracovná skupina mesta v roku 2025 potvrdila, že zákon legálne odstránenie symbolov neumožňuje. Premenovanie námestia je však priamo v kompetencii mesta a za 35 rokov sa nestalo. V novembri 2024 mesto za 11 100 € nainštalovalo kosáky a kladivá späť.',a:{polac:'agree',mudrak:'agree',lorinc:'agree'}},
  ...
  {t:'Spolupráca',q:'Má primátor Košíc ustúpiť v niektorých sporných veciach županovi KSK, aby sa obnovila spolupráca, aj keby to znamenalo kompromisy v záujmoch mesta?',info:'Konflikt medzi vedením mesta a Košickým samosprávnym krajom trvá od roku 2019 a má reálne dôsledky pre obyvateľov. Spoločné projekty v doprave, sociálnych službách a vzdelávaní sú opakovane blokované alebo oneskorované. Napríklad prepojenie dopravných systémov mesta a kraja do jedného integrovaného systému sa nepodarilo napriek tomu, že na to existujú technické aj finančné predpoklady. Každý rok nefunkčnej spolupráce stojí obyvateľov konkrétne peniaze a čas.',a:{polac:'disagree',mudrak:'agree',lorinc:'neutral'}},
  {t:'Vízia',q:'Primátor Košíc má v najbližšom volebnom období uprednostniť spoľahlivú správu každodenného chodu mesta pred presadzovaním veľkých transformačných projektov.',info:'V Košiciach sa rozbehlo niekoľko zásadných projektov naraz: nájomné bývanie, Volvo, nový územný plán, reforma mestských častí. Niektorí voliči chcú primátora, ktorý tieto projekty dotiahne do konca. Iní chcú niekoho, kto pridá ďalšie veľké vízie. Odpoveď prezradí, čo v tejto chvíli Košice podľa teba viac potrebujú.',a:{polac:'disagree',mudrak:'neutral',lorinc:'agree'}}
];
