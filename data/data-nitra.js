...
window.VAA_DATA.candidates['nitra_vuc'] = [
  ...
  {id:'blasko',name:'Erik Blaško',party:'Jednota Slovanov',color:'#3949AB',url:null},
  {id:'culakova',name:'Jolana Čuláková',party:'Nezávislá',color:'#78909C',url:null},
  {id:'suchan',name:'Karol Suchan',party:'Slovexit',color:'#E65100',url:'https://slovexit-strana.sk/'},
  {id:'svec',name:'Róbert Švec',party:'Slovenské hnutie obrody',color:'#2E7D32',url:'https://sho.sk/'}
];
...
window.VAA_DATA.questions.nitra_primator = [
  ...
  {t:'Kreatívne centrum',
   ...
   a:{hattas:'agree',uhrikova:'disagree',krsiak:'agree',illes:'neutral'}},
  ...
  {t:'Priority mesta',
   ...
   a:{hattas:'disagree',uhrikova:'agree',krsiak:'disagree',illes:'agree'}},
  ...
  {t:'Údržba mesta',
   ...
   a:{hattas:'agree',uhrikova:'agree',krsiak:'disagree',illes:'agree'}},
  ...
  {t:'Vzťah k vláde',
   ...
   a:{hattas:'disagree',uhrikova:'disagree',krsiak:'disagree',illes:'agree'}},
  ...
  {t:'Šport',
   ...
   a:{hattas:'neutral',uhrikova:'agree',krsiak:'neutral',illes:'agree'}},
  ...
  {t:'Kontrola investícií',
   ...
   a:{hattas:'agree',uhrikova:'agree',krsiak:'neutral',illes:'neutral'}},
  ...
  {t:'Mestský majetok',
   ...
   a:{hattas:'neutral',uhrikova:'neutral',krsiak:'disagree',illes:'neutral'}},
  ...
  {t:'Kúpalisko',
   ...
   a:{hattas:'neutral',uhrikova:'disagree',krsiak:'disagree',illes:'agree'}},
  ...
  {t:'Rozdelenie investícií',
   ...
   a:{hattas:'neutral',uhrikova:'disagree',krsiak:'disagree',illes:'neutral'}},
...
window.VAA_DATA.questions.nitra_vuc = [
  ...
  {t:'Vidiek a regióny',
   ...
   a:{varga:'neutral',becik:'agree',csenger:'agree',blasko:'agree',culakova:'agree',suchan:'neutral',svec:'agree'}},
  ...
  {t:'Stredné školy',
   ...
   a:{varga:'agree',becik:'agree',csenger:'agree',blasko:'agree',culakova:'agree',suchan:'agree',svec:'agree'}},
  ...
  {t:'Transparentnosť',
   ...
   a:{varga:'agree',becik:'disagree',csenger:'agree',blasko:'agree',culakova:'agree',suchan:'agree',svec:'agree'}},
  ...
  {t:'Participácia',
   ...
   a:{varga:'agree',becik:'disagree',csenger:'agree',blasko:'agree',culakova:'agree',suchan:'neutral',svec:'neutral'}},
  ...
  {t:'Kontrola výkonu',
   ...
   a:{varga:'agree',becik:'neutral',csenger:'agree',blasko:'agree',culakova:'agree',suchan:'agree',svec:'agree'}},
